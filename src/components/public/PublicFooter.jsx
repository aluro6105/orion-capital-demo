    ...
    <footer className="bg-[#070910] border-t border-white/5">
      ...
      <div className="bg-amber-500/10 border-b border-amber-500/20 px-4 py-3">
        <p className="text-center text-xs text-amber-400/80 max-w-4xl mx-auto">
          ⚠️ <strong>Aviso legal:</strong> SimuTrade TV-Lite es una plataforma educativa de simulación de trading. No es asesoría financiera. No hay ejecución real de operaciones. Los datos de mercado son simulados o con fines educativos únicamente.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-white text-sm">SimuTrade TV-Lite</span>
            </div>
            <p className="text-xs text-white/40 leading-relaxed">
              La plataforma de paper trading más avanzada para aprender a invertir sin riesgo real.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2">
              {['Términos de servicio', 'Política de privacidad', 'Descargo de responsabilidad', 'Cookies'].map(l => (
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/25">© 2026 SimuTrade TV-Lite. Todos los derechos reservados.</p>
          <p className="text-xs text-white/25">Plataforma educativa · Sin ejecución real · Sin asesoría financiera</p>
        </div>
      </div>
    </footer>
  );
