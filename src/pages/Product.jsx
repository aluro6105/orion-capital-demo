...
import {
  ...
  Zap, Lock, BarChart2, Target, BookOpen
} from 'lucide-react';
    ...
    <div className={`flex flex-col ${reverse ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-12 items-center`}>
      <div className="flex-1">
        <div className="flex items-center gap-2 mb-4">
          ...
          <span className="text-xs px-2.5 py-1 rounded-full font-semibold border" style={{ color: item.color, background: item.bg, borderColor: item.color + '30' }}>{item.tag}</span>
        </div>
      ...
      <div className="flex-1">
        {item.mockup ? (
          <MockupCard items={item.mockup} />
        ) : (
          <div className="bg-white border border-gray-100 rounded-2xl p-10 flex items-center justify-center shadow-sm h-52">
            <div className="w-20 h-20 rounded-2xl flex items-center justify-center" style={{ background: item.bg }}>
...
export default function ProductPage() {
  return (
    <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
      ...
      {/* ══════════ TRADING ══════════ */}
      <section id="trading" className="pt-32 pb-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          {/* Header Trading */}
          <div className="text-center mb-16">
            <span className="text-xs font-bold text-[#1E40AF] uppercase tracking-[0.2em] mb-3 block">Herramientas de Trading</span>
            <h2 className="text-4xl sm:text-5xl font-black text-gray-900 mb-4">
              Opera con precisión y<br /><span className="text-[#1E40AF]">análisis profesional</span>
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg">
              Gráficos avanzados, ejecución ultrarrápida e indicadores técnicos en tiempo real. Todo lo que un trader serio necesita para tomar decisiones informadas.
            </p>
          </div>
          <div className="space-y-20">
            <SectionBlock reverse={false} item={{
              icon: CandlestickChart, color: '#1E40AF', bg: '#1E40AF15',
              title: 'Gráficos de velas profesionales', tag: 'Análisis técnico',
            ...
            <SectionBlock reverse={true} item={{
              icon: Zap, color: '#2563EB', bg: '#2563EB15',
              title: 'Ejecución de órdenes instantánea', tag: 'Motor de trading',
            ...
            <SectionBlock reverse={false} item={{
              ...
              title: 'Indicadores técnicos avanzados', tag: 'Indicadores',
      ...
      {/* ══════════ MERCADOS ══════════ */}
      <section id="mercados" className="py-20 px-4 bg-[#F8FAFC]">
        <div className="max-w-6xl mx-auto">
          {/* Header Mercados */}
          <div className="text-center mb-16">
            <span className="text-xs font-bold text-[#1E40AF] uppercase tracking-[0.2em] mb-3 block">Mercados Globales</span>
            <h2 className="text-4xl sm:text-5xl font-black text-gray-900 mb-4">
              Accede a los mercados<br /><span className="text-[#1E40AF]">más importantes del mundo</span>
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg">
              184 instrumentos en un solo lugar: acciones, ETFs, Forex, criptomonedas y materias primas. Opera cualquier activo global desde una sola cuenta.
            </p>
          </div>
          <div className="space-y-20">
            <SectionBlock reverse={false} item={{
              icon: TrendingUp, color: '#1E40AF', bg: '#1E40AF15',
              title: 'Acciones y ETFs', tag: 'Renta variable',
            ...
            <SectionBlock reverse={true} item={{
              ...
              title: 'Forex y Divisas', tag: 'Mercado de cambio',
            ...
            <SectionBlock reverse={false} item={{
              ...
              title: 'Criptomonedas y Materias Primas', tag: 'Activos alternativos',
      ...
      <section id="plataforma" className="py-20 px-4 bg-white">
        <div className="max-w-6xl mx-auto">
          {/* Header Plataforma */}
          <div className="text-center mb-16">
            <span className="text-xs font-bold text-[#1E40AF] uppercase tracking-[0.2em] mb-3 block">Tecnología de Nivel Institucional</span>
            <h2 className="text-4xl sm:text-5xl font-black text-gray-900 mb-4">
              Una plataforma construida<br /><span className="text-[#1E40AF]">para traders de verdad</span>
            </h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-lg">
              Seguridad bancaria, análisis de rendimiento, cuenta demo y soporte 24/5. La infraestructura que necesitas para operar con confianza cada día.
            </p>
          </div>
          <div className="space-y-20">
            <SectionBlock reverse={false} item={{
              icon: ShieldCheck, color: '#1E40AF', bg: '#1E40AF15',
              title: 'Seguridad y protección de capital', tag: 'Seguridad',
            ...
            <SectionBlock reverse={true} item={{
              ...
              title: 'Cartera y análisis de rendimiento', tag: 'Analítica',
            ...
            <SectionBlock reverse={false} item={{
              ...
              title: 'Cuenta demo con capital virtual', tag: 'Práctica sin riesgo',
            ...
            <SectionBlock reverse={true} item={{
              ...
              title: 'Soporte y acompañamiento 24/5', tag: 'Soporte',
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-2.5">
            {['AAPL','MSFT','NVDA','TSLA','AMZN','META','GOOGL','SPY','QQQ','IWM','EUR/USD','GBP/USD','USD/JPY','USD/MXN','BTC/USD','ETH/USD','SOL/USD','XAU/USD','XAG/USD','WTI'].map(s => (
              <span key={s} className="px-3.5 py-1.5 bg-white border border-gray-200 rounded-lg text-sm font-mono text-gray-600 hover:border-[#1E40AF]/40 hover:text-[#1E40AF] transition-all">
                {s}
              </span>
            ))}
          </div>
